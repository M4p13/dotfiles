...
uniform float sc_freq = 0.3; // Frequency for the scanlines

uniform float sc_intensity = 0.05; // Intensity of the scanline effect
...
float flash_speed = 2000; // Speed of flashing effect, set to 0 to deactivate
                         
float flash_intensity = 0.03; // Intensity of flashing effect
